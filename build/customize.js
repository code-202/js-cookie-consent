...
class Customize extends React.Component {
    ...
    render() {
        ...
        return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: types.map((type) => ((0, react_1.createElement)(customize_type_1.default, { ...this.props.type, key: type.id, type: type, store: this.store }))) });
    }
}
